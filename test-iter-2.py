...
from sys import maxsize as maxval
varbound = ((-maxval, maxval), (-maxval, maxval))

###----------------------------------------------READING INPUT CSV FILE--------------------------------------###
points = csv.reader(open('points.csv'), delimiter=',')
...
###---------------------------------------- SETTING UP MODEL ----------------------------------###
model = ga(function=func, dimension = 2, algorithm_parameters={'max_num_iteration': 100}, function_timeout=10,variable_type='real',variable_boundaries=varbound)
